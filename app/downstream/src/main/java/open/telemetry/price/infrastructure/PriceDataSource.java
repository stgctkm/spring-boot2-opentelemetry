...
import open.telemetry.price.service.PriceRepository;
...
@Repository
public class PriceDataSource implements PriceRepository {

    Logger LOGGER = LoggerFactory.getLogger(PriceRepository.class);
    ...
    private static Price getPrice(long productId, double priceAmount, double discount) {
        return new Price(productId, priceAmount, discount);
    }
